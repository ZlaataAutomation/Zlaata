...
public class WebDriverManager {
    ...
    private WebDriver createDriver() {
        ...
        ClickLoggerListener clickLogger =
                new ClickLoggerListener();

        driver =
                new EventFiringDecorator<>(clickLogger)
                        .decorate(baseDriver);
    ...
    private ChromeOptions getChromeOptions() {
        ...
        // ✅ NEW CLEAN PROFILE
        // Cookies/login/session will persist

        chromeOptions.addArguments(
                "user-data-dir=C:/selenium-profile-new");
